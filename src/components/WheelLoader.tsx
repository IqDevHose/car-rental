...
const WheelLoader = () => {
  return (
    <div className="relative overflow-hidden min-h-[100vh] flex items-center justify-center">
      {/* Smoke particles - positioned closer to wheel */}
      <div className="absolute translate-x-8">
        <svg width="100" height="100" className="absolute">
          <circle
            className="animate-[smoke_2s_ease-out_infinite] opacity-0"
            cx="10"
            cy="50"
            r="3"
            fill="#9ca3af"
          />
          <circle
            className="animate-[smoke_2s_ease-out_0.4s_infinite] opacity-0"
            cx="12"
            cy="48"
            r="4"
            fill="#9ca3af"
          />
          <circle
            className="animate-[smoke_2s_ease-out_0.8s_infinite] opacity-0"
            cx="8"
            cy="52"
            r="3.5"
            fill="#9ca3af"
          />
          <circle
            className="animate-[smoke_2s_ease-out_1.2s_infinite] opacity-0"
            cx="11"
            cy="47"
            r="3"
            fill="#9ca3af"
          />
          <circle
            className="animate-[smoke_2s_ease-out_1.6s_infinite] opacity-0"
            cx="9"
            cy="49"
            r="4"
            fill="#9ca3af"
      ...
      <svg
        ...
        xml:space="preserve"
        className="w-24 h-24 fill-gray-500 animate-[spin_1s_linear_infinite]"
      >
        <g>
          <path
          ...
          <path
            ...
            c-1.821,1.114-3.82,1.956-5.951,2.474v-0.072c-1.586,0.385-3.233,0.612-4.938,0.612s-3.352-0.227-4.938-0.612z
